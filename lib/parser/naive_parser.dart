...
/// RDF doc for complete turtle grammar can be found at
...
/// Note:
/// 1. '?' zero or one time
/// 2. Using starGreedy() to avoid greedy matching all. E.g, (PN_CHARS | '.')*
/// will consume the following PN_CHARS if not careful.
/// 3. In normal regex, a $ will be enough, with petitparser, need to use
/// starGreedy/plusGreedy to make it work.
...
///
/// Note:
/// Needs to rearrange the order as INTEGER will greedy match for the default
/// sequence.
...
final sparqlPrefix =
    string('PREFIX', ignoreCase: true) & PNAME_NS.trim() & IRIREF;

/// [5s] 	sparqlBase 	::= 	"BASE" IRIREF
final sparqlBase = string('BASE', ignoreCase: true) & IRIREF.trim();
